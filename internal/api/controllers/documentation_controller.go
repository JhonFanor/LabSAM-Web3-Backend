...
func (d *DocumentationController) SetDocumentationApproval(c *gin.Context) {
	idParam := c.Param("id")
	...
	err = d.service.SetDocumentationApproval(uint(id), req.Approved, claims.UserID, claims.Role)
	if err != nil {
